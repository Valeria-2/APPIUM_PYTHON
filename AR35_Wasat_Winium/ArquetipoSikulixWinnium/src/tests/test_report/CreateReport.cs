...
using SeleniumAndSikuli.src.tests.test_report.lectura_archivos;
...
namespace SeleniumAndSikuli.src.tests.test_report
{
    public class Createreport
    {
        ...
        public string CreateReport(string csvRoute, string reportName)
        {
            ...
            if (!Directory.Exists(Path.Combine(solutionDirectory, ReportConstant.CarpetaReporte)))
            {
                Directory.CreateDirectory(Path.Combine(solutionDirectory, ReportConstant.CarpetaReporte));
            }
            ...
            DeviceRgb yellowColor = new DeviceRgb(0xF9, 0xB0, 0x17);
            ...
            Table stepsTable = new Table(1, false);
            ...
            Table expectedResultsTable = new Table(1, false);
            ...
            reportModel.ForEach(line =>
            {
                ...
                {
                    Image screenshot = new Image(ImageDataFactory.Create(line.InputRoute));
        ...
        {
            Image devsecops = new Image(ImageDataFactory.Create(Devsecops_path));
        ...
        {
            Image basee = new Image(ImageDataFactory.Create(BaseI_path));
        ...
        {
            Image encabezado = new Image(ImageDataFactory.Create(Encabezado_path));
        ...
        {
            DeviceRgb redColor = new DeviceRgb(0xE4, 0x20, 0x14);

            Table dataTable = new Table(2, false);
