...
using SeleniumArquetipo1.Src.Test.TestData;
...
{
    internal class TestDataDrivenExcel : BaseChromeTest
    {
        [TestCaseSource(typeof(DataHelper), nameof(DataHelper.ExcelUserData))]
        public void ValidUserDataFromExcel(string tcname, string username, string password)
        { //ARRANGE
